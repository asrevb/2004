...
# client vars
API_ID = int(getenv("API_ID", "26837612"))
API_HASH = getenv("API_HASH", "9f9df881393b28aca8c0f9863d345314")
BOT_TOKEN = getenv("BOT_TOKEN", "5764652830:AAHrG-vhm9TEZndk8NG6F7zxtZTLM5ee6fQ")
...
# mandatory vars
OWNER_USERNAME = getenv("OWNER_USERNAME", "atv340")
ALIVE_NAME = getenv("ALIVE_NAME", "atv340")
BOT_USERNAME = getenv("BOT_USERNAME", "asryybot")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/STKR2/2004")
UPSTREAM_BRANCH = getenv("UPSTREM_BRANCH", "main")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "60"))
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "xvxzvxx")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "asniim")
